...
for i, atoms in enumerate(traj):
    atoms.calc = ORCA(charge=-1, mult=1, directory="ORCA", orcasimpleinput="WB97X-D4 def2-TZVPD"+simpleinput, orcablocks="%pal nprocs 32 end"+blocks) # PRINTMOS PRINTBASIS to visualize orbitals with .out
