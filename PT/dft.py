...
for i, atoms in enumerate(traj):
    ...
    atoms.calc = ORCA(charge=0, mult=1, directory="ORCA", orcasimpleinput='WB97X-D4 def2-TZVP', orcablocks="%pal nprocs 16 end") # PRINTMOS PRINTBASIS to visualize orbitals with .out
