...
def trj_dd(time, dd):
    ...
    ax.set_xlabel("t [ps]")
    ax.set_ylabel(r"$d_{H-O_1} - d_{H-O_2}\ [A]$")
...
def density_dd(grid, density):
    ...
    ax.set_xlabel(r"$d_{H-O_1} - d_{H-O_2}\ [A]$")
...
def chemiscope(structures, time, d1, d2):
    properties = {"d1": {"target": "structure",
                        "values": d1,
                        "description": "Distance between the hydrogen atom and the first oxygen atom"},
                  "d2": {"target": "structure",
                        "values": d2,
                        "description": "Coordination between the hydrogen atom and the second oxygen atom"},
